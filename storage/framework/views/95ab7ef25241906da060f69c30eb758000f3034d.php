...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        search_buku_besar = () => {
            ...
            $.post("<?php echo e(route('buku_besar.search')); ?>", data, (result) => {
        ...
        cetak = () => {
            ...
            window.open("<?php echo e(route('buku_besar.cetak')); ?>?" + params.join('&'), '_blank');
        }
    </script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Semester 4\Pengkodean\akuntansi\resources\views/buku_besar/index.blade.php ENDPATH**/ ?>