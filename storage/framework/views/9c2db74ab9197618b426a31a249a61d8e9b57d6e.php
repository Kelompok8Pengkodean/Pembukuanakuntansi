...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        search_neraca = () => {
            ...
            $.post("<?php echo e(route('neraca.search')); ?>", data, (result) => {
        ...
        cetak = () => {
            ...
            window.open("<?php echo e(route('neraca.cetak')); ?>?" + params.join('&'), '_blank');
        }
    </script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Semester 4\Pengkodean\akuntansi\resources\views/neraca/index.blade.php ENDPATH**/ ?>