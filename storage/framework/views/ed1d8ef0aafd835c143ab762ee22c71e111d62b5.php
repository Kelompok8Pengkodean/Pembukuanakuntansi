...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        search_laba_rugi = () => {
            ...
            $.post("<?php echo e(route('laba_rugi.search')); ?>", data, (result) => {
        ...
        cetak = () => {
            ...
            window.open("<?php echo e(route('laba_rugi.cetak')); ?>?" + params.join('&'), '_blank');
        }
    </script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Semester 4\Pengkodean\akuntansi\resources\views/laba_rugi/index.blade.php ENDPATH**/ ?>