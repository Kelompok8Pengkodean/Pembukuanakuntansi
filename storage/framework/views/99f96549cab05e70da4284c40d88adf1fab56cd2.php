...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        search_arus_kas = () => {
            ...
            $.post("<?php echo e(route('arus_kas.search')); ?>", data, (result) => {
        ...
        cetak = () => {
            ...
            window.open("<?php echo e(route('arus_kas.cetak')); ?>?" + params.join('&'), '_blank');
        }
    </script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Semester 4\Pengkodean\akuntansi\resources\views/arus_kas/index.blade.php ENDPATH**/ ?>